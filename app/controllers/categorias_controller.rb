class CategoriasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categoria.save
        format.html { redirect_to @categoria, notice: 'La Categoria se creo satisfactoriamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @categoria.update_attributes(params[:categoria])
        format.html { redirect_to @categoria, notice: 'La Categoria se actualizo satisfactoriamente.' }
        format.json { head :ok }
      else
