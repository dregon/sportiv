class ComentariosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comentario.save
        format.html { redirect_to @comentario, notice: 'El Comentario se creo satisfactoriamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @comentario.update_attributes(params[:comentario])
        format.html { redirect_to @comentario, notice: 'El Comentario se actualizo satisfactoriamente.' }
        format.json { head :ok }
      else
